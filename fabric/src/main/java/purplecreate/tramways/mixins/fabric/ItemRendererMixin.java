...
public abstract class ItemRendererMixin implements IRGBItemRenderer {
  ...
  @WrapOperation(method = "renderQuadList", at = @At(value = "INVOKE", target = "Lcom/mojang/blaze3d/vertex/VertexConsumer;putBulkData(Lcom/mojang/blaze3d/vertex/PoseStack$Pose;Lnet/minecraft/client/renderer/block/model/BakedQuad;FFFII)V"))
  private void tramways$renderImpl(VertexConsumer instance, PoseStack.Pose pose, BakedQuad quad, float red, float green, float blue, int combinedLight, int combinedOverlay, Operation<Void> original) {
    ...
    original.call(instance, pose, quad, red, green, blue, combinedLight, combinedOverlay);
  }
}
